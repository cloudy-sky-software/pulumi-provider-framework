...
require (
	github.com/cloudy-sky-software/pulschema v0.0.0-20260810141725-aba9cd208501
...
require (
	...
	github.com/pulumi/pulumi-dotnet/pulumi-language-dotnet/v3 v3.111.0 // indirect
